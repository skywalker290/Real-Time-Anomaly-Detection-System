...
# Set paths
base_dir = 'normal_anomaly'
anomaly_dir = os.path.join(base_dir, 'Anomaly-Videos')
normal_dir = os.path.join(base_dir, 'Training-Normal-Videos')

# Destination folders
output_base = 'Anomaly-detection-Dataset'
splits = ['train', 'test', 'val']

# Split ratios
split_ratios = {'train': 0.6, 'test': 0.3, 'val': 0.1}
